...
// Agregamos : Record<string, any> para permitir acceso dinámico por índice string
export const appointments_catalog: Record<string, any> = {
  "branch-principal": [
    {
      id: "a-1",
...
export const inventory_snapshot: Record<string, any> = {
  "branch-principal": [
...
export const promotions_board: Record<string, any> = {
  "branch-principal": [
...
export const points_summary: Record<string, any> = {
...
export const points_history: Record<string, any> = {
  "branch-principal": [
...
export const commissions_log: Record<string, any> = {
...
export const notifications_list: Record<string, any> = {
  "branch-principal": [
    {
      id: "n-1",
      tipo: "recordatorio",
